...
install -d -m 755 -o cjh -g cjh /data/autovideosrt/browser/profiles/tabcut
...
install -d -m 755 -o cjh -g cjh /data/autovideosrt/browser/runtime-tabcut
...
install -d -m 755 -o cjh -g cjh /data/autovideosrt/browser/logs/tabcut
...
install -m 644 "$APP_DIR/deploy/server_browser/autovideosrt-tabcut-vnc.service" /etc/systemd/system/autovideosrt-tabcut-vnc.service
...
systemctl enable --now autovideosrt-dxm01-meta-vnc.service autovideosrt-dxm02-mk-vnc.service autovideosrt-dxm03-rjc-vnc.service autovideosrt-tabcut-vnc.service
