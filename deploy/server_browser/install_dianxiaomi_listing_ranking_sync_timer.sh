...
SERVICE_NAME="${SERVICE_NAME:-autovideosrt-dianxiaomi-listing-ranking-sync}"
...
echo "[dianxiaomi-listing-ranking-sync] timer status"
systemctl list-timers "${SERVICE_NAME}.timer" --no-pager
echo
echo "[dianxiaomi-listing-ranking-sync] install done"
