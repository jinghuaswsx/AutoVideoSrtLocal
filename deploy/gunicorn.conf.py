...
- post_worker_init chains a SIGTERM / SIGINT handler that flips the
  ...
  own handler.
- worker_exit triggers the coordinator one more time, shuts down
  APScheduler, and waits up to 200s for in-flight tracked threads to
  honour the cooperative cancellation points and unregister.
