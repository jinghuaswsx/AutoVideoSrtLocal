(function() {
  ...
  function ensureAiEvaluationRequestModalStyle() {
    ...
    style.textContent = `
      ...
      .ect-ai-inline-summary { margin-top:12px; border:1px solid var(--oc-border, oklch(91% 0.012 230)); border-radius:8px; padding:12px; background:var(--oc-bg-subtle, oklch(97% 0.006 230)); display:grid; gap:8px; }
      ...
      .ect-ai-inline-summary-meta { display:flex; flex-wrap:wrap; gap:8px 14px; color:var(--oc-fg-muted, oklch(48% 0.018 230)); font-size:12px; }
      .ect-ai-inline-summary-meta strong { color:var(--oc-fg, oklch(22% 0.020 235)); font-weight:700; }
      .ect-ai-inline-summary-list { display:grid; gap:6px; }
      .ect-ai-inline-summary-item { color:var(--oc-fg, oklch(22% 0.020 235)); font-size:12px; line-height:1.55; overflow-wrap:anywhere; }
      .ect-ai-inline-summary-country { color:var(--oc-fg-muted, oklch(48% 0.018 230)); font-weight:700; margin-right:6px; }
