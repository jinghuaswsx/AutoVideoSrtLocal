...
from web.routes.video_cover import bp as video_cover_bp
...
from web.routes.omni_translate_0615 import bp as omni_translate_0615_bp
...
from web.routes.notifications import bp as notifications_bp
...
from web.routes.video_analyse_ai import bp as video_analyse_ai_bp
...
def create_app() -> Flask:
    ...
    csrf.exempt(omni_translate_0615_bp)
    ...
    app.register_blueprint(video_cover_bp)
    ...
    app.register_blueprint(omni_translate_0615_bp)
    ...
    app.register_blueprint(order_profit_bp)
    csrf.exempt(order_profit_bp)
    ...
    app.register_blueprint(video_analyse_ai_bp)
    csrf.exempt(video_analyse_ai_bp)
    app.register_blueprint(ad_alerts_bp)
    csrf.exempt(ad_alerts_bp)
