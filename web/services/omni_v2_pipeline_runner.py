"""OmniV2TranslateRunner SocketIO adapter (mirrors omni_pipeline_runner)."""
...
def start(task_id: str, user_id: int | None = None) -> bool:
    ...
    runner = OmniV2TranslateRunner(bus=bus, user_id=user_id)
...
runner_dispatch.register_omni_v2_translate_runner(
