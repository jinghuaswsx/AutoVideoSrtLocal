"""OmniTranslate0615Runner SocketIO adapter (mirrors multi_pipeline_runner)."""
...
def start(task_id: str, user_id: int | None = None) -> bool:
    ...
    runner = OmniTranslate0615Runner(bus=bus, user_id=user_id)
...
runner_dispatch.register_omni_translate_0615_runner(
