...
from web.services.media_shopify_image import (
    ...
    shopify_image_flask_response as _shopify_image_flask_response_impl,
)
...
def _shopify_image_flask_response(result):
    return _shopify_image_flask_response_impl(result)
