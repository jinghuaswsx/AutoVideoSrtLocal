...
@bp.route("/api/multi-translate/<task_id>/llm-debug/<step>", methods=["GET"])
@login_required
...
@bp.route("/api/multi-translate/<task_id>/voice-ai-ranking/force-speed-fallback", methods=["POST"])
@login_required
@admin_required
