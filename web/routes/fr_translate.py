...
@bp.route("/api/fr-translate/<task_id>/confirm-alignment", methods=["POST"])
@login_required
...
@bp.route("/api/fr-translate/<task_id>/confirm-segments", methods=["POST"])
@login_required
...
@bp.route("/api/fr-translate/<task_id>/confirm-translate", methods=["POST"])
@login_required
...
@bp.route("/api/fr-translate/<task_id>/resume/<step>", methods=["POST"])
@login_required
def resume(task_id, step):
    ...
    fr_pipeline_runner.resume(task_id, step, user_id=current_user.id)
