...
CREATIVE_DIRECTOR_PROMPT_TEMPLATE = """请基于上传的产品图片、精选视频帧、产品分析、视频分析和 selected_ad_copy，生成一张 9:16 竖版有文字封面图，用于 Facebook Reels / Instagram Reels / TikTok / Shorts。
请像一位优秀的创意总监一样思考：目标是做出一张适合西方社交媒体、能提升短视频点击率的完整封面图。
...
最终任务：
生成一张强有力的 9:16 竖版有文字封面图，在产品准确性、正确使用方式、高点击吸引力和自然 hook 嵌入之间取得平衡。"""
...
字段含义必须严格对齐：
- title：对应业务格式里的“标题”，也是封面图模型原生嵌入使用的唯一文字。
