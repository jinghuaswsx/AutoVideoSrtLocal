        ...
        segments.append(
            {
                ...
                "voice_id": sentence.get("voice_id"),
                "voice_name": sentence.get("voice_name"),
                ...
                "second_rewrite_attempted": bool(sentence.get("second_rewrite_attempted")),
                "second_rewrite_result": sentence.get("second_rewrite_result"),
                "second_rewrite_before_text": sentence.get("second_rewrite_before_text"),
                "second_rewrite_after_text": sentence.get("second_rewrite_after_text"),
                "second_rewrite_selected": sentence.get("second_rewrite_selected"),
                "second_rewrite_selected_round": sentence.get("second_rewrite_selected_round"),
                "second_rewrite_tts_duration": sentence.get("second_rewrite_tts_duration"),
                "second_rewrite_target_duration": sentence.get("second_rewrite_target_duration"),
                "second_rewrite_duration_ratio": sentence.get("second_rewrite_duration_ratio"),
                "second_rewrite_delta_pct": sentence.get("second_rewrite_delta_pct"),
                "second_rewrite_status": sentence.get("second_rewrite_status"),
                "second_rewrite_reason": sentence.get("second_rewrite_reason"),
                "second_rewrite_attempts": list(sentence.get("second_rewrite_attempts") or []),
                # Backward compat: old final_extra_expand fields mapped to new names
                "final_extra_expand_attempted": bool(sentence.get("second_rewrite_attempted")),
                "final_extra_expand_result": sentence.get("second_rewrite_result"),
                "final_extra_expand_before_text": sentence.get("second_rewrite_before_text"),
                "final_extra_expand_after_text": sentence.get("second_rewrite_after_text"),
                "final_extra_expand_selected": sentence.get("second_rewrite_selected"),
                "final_extra_expand_selected_round": sentence.get("second_rewrite_selected_round"),
                "final_extra_expand_tts_duration": sentence.get("second_rewrite_tts_duration"),
                "final_extra_expand_target_duration": sentence.get("second_rewrite_target_duration"),
                "final_extra_expand_duration_ratio": sentence.get("second_rewrite_duration_ratio"),
                "final_extra_expand_delta_pct": sentence.get("second_rewrite_delta_pct"),
                "final_extra_expand_status": sentence.get("second_rewrite_status"),
                "final_extra_expand_reason": sentence.get("second_rewrite_reason"),
                "final_extra_expand_attempt": sentence.get("second_rewrite_attempts", [None])[0] if sentence.get("second_rewrite_attempts") else None,
            }
        )
    return segments
