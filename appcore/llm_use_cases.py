...
USE_CASES: dict[str, UseCase] = {
    ...
    "omni_av_sync.assess": _uc(
        ...
        "omni_translate",
        "Omni 音画同步结构化评估",
        "Gemini 3.5 Flash 结合 Doubao 视频理解笔记、ASR 和 TTS 文案输出逐段评分卡",
        "openrouter",
    ...
    "omni_av_sync.verify": _uc(
        ...
        "omni_translate",
        "Omni 音画同步复核",
        "Gemini 3.5 Flash 复核 Doubao 音画同步问题候选，只保留可安全处理的问题",
        "openrouter",
        "google/gemini-3.5-flash",
        "openrouter",
        "tokens",
    ...
    "asr_clean.purify_fallback": _uc(
        ...
        "asr_clean",
        "ASR 同语言纯净化（兜底）",
        "Claude Sonnet 兜底：主路校验失败时换异家族模型重跑同样 prompt",
        "openrouter",
    ...
    "medias.ai_material_strategist_rank_products": _uc(
        ...
        "material",
        "AI素材军师 Top30 排名",
        "使用 GoogleWJ Gemini 3.5 Flash 复评素材管理产品表现，筛出有量且 ROAS 不差的 Top30",
        "google_wj",
        "gemini-3.5-flash",
        "google_wj",
        "tokens",
    ...
    "medias.ad_material_ai_analysis_rank_products": _uc(
    ...
    "medias.ad_material_ai_analysis_product_analysis": _uc(
        "medias.ad_material_ai_analysis_product_analysis",
        "material",
        "投放素材AI分析单品评审",
        "使用 GoogleWJ Gemini 3.5 Flash 按商品历史、达人数据、趋势和视频取证评估补素材优先级",
        "google_wj",
        "gemini-3.5-flash",
        "google_wj",
        "tokens",
    ...
    "order_analytics.weekly_product_action_evaluation": _uc(
        "order_analytics.weekly_product_action_evaluation",
        "order_analytics",
        "每周稳定潜力品 AI 推进评估",
        "针对每周 AI 分析中的稳定品和潜力品，结合投放、订单、素材和国家分布生成逐产品推进建议",
        "openrouter",
        "google/gemini-3.5-flash",
        "openrouter",
        "tokens",
    ...
    "tabcut.translate_video_info": _uc(
