...
USE_CASES: dict[str, UseCase] = {
    ...
    "meta_hot_posts.europe_fit": _uc(
        ...
        "xuanpin",
        "Meta 热帖欧洲投放适配评估",
        "用 Google Vertex ADC Gemini 3.1 Pro Preview 评估热帖视频和商品链接是否适合直接搬运到欧洲 Meta 广告市场",
        "gemini_vertex_adc",
        "gemini-3.1-pro-preview",
        "gemini_vertex_adc",
        "tokens",
    ...
    "meta_hot_posts.video_copyability": _uc(
        ...
        "xuanpin",
        "Meta 热帖视频可抄适配度",
        "使用 Google Vertex ADC Gemini 3.1 Pro Preview 分析本地化热帖视频是否适合直接抄作业投放美国 Meta 市场广告",
        "gemini_vertex_adc",
        "gemini-3.1-pro-preview",
        "gemini_vertex_adc",
        "tokens",
