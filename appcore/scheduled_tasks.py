...
TASK_DEFINITIONS: dict[str, TaskDefinition] = {
    ...
    "mingkong_material_daily_snapshot": {
        ...
        "name": "明空素材每日快照",
        "description": (
            "每天 06:00、18:00 读取店小秘 Listing 最新可用快照 Top300 产品 code，"
        ...
        "schedule": "每天 06:00、18:00（北京时间，每轮跑完前300产品后结束）",
        "source_type": "systemd",
        "source_label": "Linux systemd timer",
    ...
    "meta_hot_posts_video_analysis_queue_tick": {
        ...
        "description": (
            ...
            "Each round processes at most 22 tasks with a 10 second delay between LLM video calls; "
