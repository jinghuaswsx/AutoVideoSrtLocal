...
TASK_DEFINITIONS: dict[str, TaskDefinition] = {
    ...
    "tabcut_video_translation_tick": {
        "code": "tabcut_video_translation_tick",
        "name": "Tabcut 视频中文信息补全",
        "description": (
            "每 10 分钟批量处理未翻译的 Tabcut 视频，默认每轮最多 250 个视频，可在系统设置调整；调用 OpenRouter "
        ...
        "source_type": "apscheduler",
        "source_label": "Web 进程 APScheduler",
        "source_ref": "tabcut_video_translation_tick",
