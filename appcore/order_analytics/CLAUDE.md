...
- 实时大盘默认 ROAS 走势与子 Tab 刷新边界：`docs/superpowers/specs/2026-06-09-data-analysis-realtime-roas-default-subtab.md`
- 实时大盘估算证据页：`docs/superpowers/specs/2026-06-07-realtime-dashboard-estimate-evidence-design.md`
...
- 未匹配明细移动端 / 商品信息：`docs/superpowers/specs/2026-06-07-realtime-unmatched-mobile-assets-design.md`
