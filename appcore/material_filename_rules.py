...
def validate_material_filename(
    ...
    """Validate a material video filename and return a copyable suggestion on mismatch."""
    ...
    if effective_lang == "en":
        errors = _validate_english_filename(filename, product_name)
    else:
...
def build_suggested_material_filename(
    ...
    if lang == "en":
        return f"{date_part}-{product_name}-原素材.mp4"
