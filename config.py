...
TOS_ASR_BUCKET = _env("TOS_ASR_BUCKET", "autovideosrtlocal")
...
SUBTITLE_REMOVAL_RESUBMIT_POLL_WINDOW_SECONDS = int(_env("SUBTITLE_REMOVAL_RESUBMIT_POLL_WINDOW_SECONDS", "1800"))
# 字幕擦除后端选择：goodline（第三方 API）| vod（火山引擎点播）
SUBTITLE_REMOVAL_PROVIDER = _env("SUBTITLE_REMOVAL_PROVIDER", "goodline").strip().lower()
# 本地 VSR 字幕移除服务；服务文档见 /home/cjh/code/SubtitleRemover/docs/api.md
SUBTITLE_REMOVAL_LOCAL_VSR_BASE_URL = _env("SUBTITLE_REMOVAL_LOCAL_VSR_BASE_URL", "http://127.0.0.1:84")
SUBTITLE_REMOVAL_LOCAL_VSR_MAX_DURATION_SECONDS = int(_env("SUBTITLE_REMOVAL_LOCAL_VSR_MAX_DURATION_SECONDS", "3600"))
SUBTITLE_REMOVAL_LOCAL_VSR_SUBMIT_TIMEOUT_SECONDS = int(_env("SUBTITLE_REMOVAL_LOCAL_VSR_SUBMIT_TIMEOUT_SECONDS", "120"))
SUBTITLE_REMOVAL_LOCAL_VSR_POLL_TIMEOUT_SECONDS = int(_env("SUBTITLE_REMOVAL_LOCAL_VSR_POLL_TIMEOUT_SECONDS", "30"))
SUBTITLE_REMOVAL_LOCAL_VSR_DOWNLOAD_TIMEOUT_SECONDS = int(_env("SUBTITLE_REMOVAL_LOCAL_VSR_DOWNLOAD_TIMEOUT_SECONDS", "120"))
...
PUSH_PRODUCT_LINKS_BASE_URL = _env("PUSH_PRODUCT_LINKS_BASE_URL", "https://os.wedev.vip")
PUSH_PRODUCT_LINKS_USERNAME = _env("PUSH_PRODUCT_LINKS_USERNAME", "蔡靖华")
PUSH_PRODUCT_LINKS_PASSWORD = _env("PUSH_PRODUCT_LINKS_PASSWORD", "")
