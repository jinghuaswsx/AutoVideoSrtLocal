...
-- Docs-anchor: docs/superpowers/specs/2026-06-10-tabcut-detail-task-actions.md
...
SET @ddl := IF(
  ...
  'ALTER TABLE tabcut_videos
     ADD COLUMN local_product_id INT UNSIGNED NULL,
     ADD COLUMN local_media_item_id INT UNSIGNED NULL,
