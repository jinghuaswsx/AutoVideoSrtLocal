...
CREATE TABLE IF NOT EXISTS projects (
    ...
    user_id          INT NOT NULL,
    type             ENUM('translation','copywriting','video_creation','video_review','text_translate','de_translate','fr_translate','subtitle_removal','translate_lab') NOT NULL DEFAULT 'translation',
