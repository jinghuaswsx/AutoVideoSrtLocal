...
- 任务中心端到端流程：`2026-05-16-task-center-e2e-flow-design.md`（选品→任务→素材→推送全链路补全）；详情过程视图见 `2026-05-20-task-center-review-process-view-design.md`；按语言独立翻译指派见 `2026-05-20-task-center-per-language-assignment-design.md`
