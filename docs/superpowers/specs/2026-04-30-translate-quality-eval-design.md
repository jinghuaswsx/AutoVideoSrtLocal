...
| 原稿 | task_id | 题材 | 长度 |
|---|---|---|---|
| 英文 A | `e51759992ed5516388897810782aa1f0` | 厨房用品（ice ball mold） | 111 词 |
| 英文 B | `12c71abff2be555ab1547d94a53288e8` | 户外工具（utility knife） | 108 词 |

> **数据现状说明**：原 spec 假设 1 中 + 1 英，但扫了最近 300 个 task 全部是英文源稿（用户主业务已转向英文短视频翻译多语种），改为 2 段题材差异大的英文原稿。挑选规则：长度 ≥80 词、内容完整连贯、最近素材、品类不同。

### 4.2 翻译矩阵

| 维度 | 取值 | 数量 |
|---|---|---|
| 英文原稿目标语种 | de, es, fr, it, ja, nl, pt, sv（排除 en 自身） | 8 |
...
| 项 | 次数 | 估算金额 |
|---|---|---|
| Claude Sonnet 4.6 | 16 | ¥1.0 |
| Gemini 3.1 Pro | 16 | ¥3.0 |
| Gemini 3 Flash | 16 | ¥0.5 |
| 我评估的 token | ~25k | ¥1.5 |
| **合计** | | **¥6** |
