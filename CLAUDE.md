...
- 告警链路：`appcore/scheduled_tasks._dispatch_failure_alert` 走「连续 2 次同 task 失败」门（2026-05-09 起），单次瞬时失败不发飞书；`meta_daily_final` 收盘日同步遇到一次失败 + 17:00 check 补跑成功不会刷屏，连续两次失败才触发飞书报警。
