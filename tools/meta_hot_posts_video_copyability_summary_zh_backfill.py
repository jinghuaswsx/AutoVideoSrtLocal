...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    while True:
        ...
        batch = video_copyability_translation.run_pending_summary_translations(
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Backfill Chinese summaries for Meta hot-post video copyability analyses."
    )
