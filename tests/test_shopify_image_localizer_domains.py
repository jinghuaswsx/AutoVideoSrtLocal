...
def test_shopify_image_localizer_release_version_is_supported() -> None:
    major, minor = version.RELEASE_VERSION.split(".", 1)
...
def test_load_runtime_config_uses_pyinstaller_internal_default_when_root_config_missing(
    tmp_path,
