...
def test_task_center_timeline_renders_review_assets_in_steps():
    ...
    assert "tcRenderEventTimeline(task, events, reviewAssets)" in source
    ...
    assert "function tcShouldShowSubtitleRemovalComparison" in source
    ...
    assert "tcRenderSubtitleRemovalComparison(event, context)" in source
