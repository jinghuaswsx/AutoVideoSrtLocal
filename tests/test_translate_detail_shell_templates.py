...
def test_sentence_reconcile_process_is_rendered_in_tts_duration_log():
    ...
    assert "second_rewrite_start" in script
    assert "second_rewrite_result" in script
    assert "second_rewrite_attempts" in script
    assert "second_rewrite_selected" in script
