...
def test_quality_assessment_list_route_supports_dialogue_project_type(
    authed_client_no_db,
    monkeypatch,
):
    from web.routes import translation_quality as route
    ...
    resp = authed_client_no_db.get(
        "/api/dialogue-translate/task-quality/quality-assessments"
    )
...
def test_quality_assessment_run_route_supports_dialogue_project_type(
    authed_client_no_db,
    monkeypatch,
):
    from web.routes import translation_quality as route
    ...
    resp = authed_client_no_db.post(
        "/api/dialogue-translate/task-quality/quality-assessments/run"
    )
